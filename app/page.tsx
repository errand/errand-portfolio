        ...
        <main className="flex min-h-screen flex-col items-center justify-center p-24">
            <div className="text-center">
                <div className={'mb-12'}>
                    ...
                    {/* Показываем второй Typewriter только после завершения первого */}
                            ...
                            <Typewriter
                                ...
                                onInit={(typewriter) => {
                                    typewriter
                                        ...
                                        .pauseFor(300)
                                        .deleteChars(8) // Удаляем "ront-end" (9 символов)
                                        .typeString('ull-stack web-engineer')
                                        .callFunction(() => {
                                            setSecondTypewriterFinished(true);
                                        })
                                        .start();
                                }}
                            />
                ...
                {/* Показываем иконки только после завершения обоих Typewriter'ов */}
                {secondTypewriterFinished && (
                        ...
                        >
                            <Link href={'https://www.linkedin.com/in/aleksandr-shatskikh'} target={'_blank'} rel={'nofollow'}>
                                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512"
                                     className="h-10 w-10" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                                    <path
